...
/**
 * The TopicSchema model module.
 * @module model/TopicSchema
 * @version 1.0.0
 */
export class TopicSchema {
  /**
   * Constructs a new <code>TopicSchema</code>.
   * @alias module:model/TopicSchema
   * @class
   * @param type {String} 
   * @param source {String} 
   */
  ...
  /**
   * Constructs a <code>TopicSchema</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TopicSchema} obj Optional instance to populate.
   * @return {module:model/TopicSchema} The populated <code>TopicSchema</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TopicSchema();
 ...
 * @member {String} type
 */
TopicSchema.prototype.type = undefined;

/**
 * @member {String} source
 */
TopicSchema.prototype.source = undefined;
