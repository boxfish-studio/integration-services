...
/**
 * The IdentityIdSchema model module.
 * @module model/IdentityIdSchema
 * @version 1.0.0
 */
export class IdentityIdSchema {
  /**
   * Constructs a new <code>IdentityIdSchema</code>.
   * @alias module:model/IdentityIdSchema
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>IdentityIdSchema</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IdentityIdSchema} obj Optional instance to populate.
   * @return {module:model/IdentityIdSchema} The populated <code>IdentityIdSchema</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new IdentityIdSchema();
    }
    return obj;
  }
}
