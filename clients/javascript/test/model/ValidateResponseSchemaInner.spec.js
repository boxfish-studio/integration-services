...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ValidateResponseSchemaInner', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.ValidateResponseSchemaInner();
      });

      it('should create an instance of ValidateResponseSchemaInner', function() {
        // TODO: update the code to test ValidateResponseSchemaInner
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.ValidateResponseSchemaInner);
      });
      ...
      it('should have the property tangleLog (base name: "tangleLog")', function() {
        // TODO: update the code to test the property tangleLog
        expect(instance).to.have.property('tangleLog');
        // expect(instance.tangleLog).to.be(expectedValueLiteral);
      });
