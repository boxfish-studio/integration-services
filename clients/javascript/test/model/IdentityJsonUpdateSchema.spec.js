...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IdentityJsonUpdateSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.IdentityJsonUpdateSchema();
      });

      it('should create an instance of IdentityJsonUpdateSchema', function() {
        // TODO: update the code to test IdentityJsonUpdateSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.IdentityJsonUpdateSchema);
      });
