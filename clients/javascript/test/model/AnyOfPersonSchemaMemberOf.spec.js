...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfPersonSchemaMemberOf', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfPersonSchemaMemberOf();
      });

      it('should create an instance of AnyOfPersonSchemaMemberOf', function() {
        // TODO: update the code to test AnyOfPersonSchemaMemberOf
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfPersonSchemaMemberOf);
      });
