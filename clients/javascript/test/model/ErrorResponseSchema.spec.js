...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ErrorResponseSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.ErrorResponseSchema();
      });

      it('should create an instance of ErrorResponseSchema', function() {
        // TODO: update the code to test ErrorResponseSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.ErrorResponseSchema);
      });
