...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChannelDataSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.ChannelDataSchema();
      });

      it('should create an instance of ChannelDataSchema', function() {
        // TODO: update the code to test ChannelDataSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.ChannelDataSchema);
      });
