...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NonceSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.NonceSchema();
      });

      it('should create an instance of NonceSchema', function() {
        // TODO: update the code to test NonceSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.NonceSchema);
      });
