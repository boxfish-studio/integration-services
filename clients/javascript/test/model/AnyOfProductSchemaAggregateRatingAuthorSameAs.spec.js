...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaAggregateRatingAuthorSameAs', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingAuthorSameAs();
      });

      it('should create an instance of AnyOfProductSchemaAggregateRatingAuthorSameAs', function() {
        // TODO: update the code to test AnyOfProductSchemaAggregateRatingAuthorSameAs
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingAuthorSameAs);
      });
