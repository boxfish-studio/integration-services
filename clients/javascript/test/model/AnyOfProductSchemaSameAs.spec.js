...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaSameAs', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaSameAs();
      });

      it('should create an instance of AnyOfProductSchemaSameAs', function() {
        // TODO: update the code to test AnyOfProductSchemaSameAs
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaSameAs);
      });
