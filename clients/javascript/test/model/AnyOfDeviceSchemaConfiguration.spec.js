...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfDeviceSchemaConfiguration', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfDeviceSchemaConfiguration();
      });

      it('should create an instance of AnyOfDeviceSchemaConfiguration', function() {
        // TODO: update the code to test AnyOfDeviceSchemaConfiguration
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfDeviceSchemaConfiguration);
      });
