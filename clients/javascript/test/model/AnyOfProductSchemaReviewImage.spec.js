...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaReviewImage', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaReviewImage();
      });

      it('should create an instance of AnyOfProductSchemaReviewImage', function() {
        // TODO: update the code to test AnyOfProductSchemaReviewImage
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaReviewImage);
      });
