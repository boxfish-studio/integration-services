...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaReviewReviewRatingSameAs', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaReviewReviewRatingSameAs();
      });

      it('should create an instance of AnyOfProductSchemaReviewReviewRatingSameAs', function() {
        // TODO: update the code to test AnyOfProductSchemaReviewReviewRatingSameAs
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaReviewReviewRatingSameAs);
      });
