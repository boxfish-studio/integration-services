...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfServiceSchemaSameAs', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfServiceSchemaSameAs();
      });

      it('should create an instance of AnyOfServiceSchemaSameAs', function() {
        // TODO: update the code to test AnyOfServiceSchemaSameAs
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfServiceSchemaSameAs);
      });
