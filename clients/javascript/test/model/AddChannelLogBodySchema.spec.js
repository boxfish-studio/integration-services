...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddChannelLogBodySchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AddChannelLogBodySchema();
      });

      it('should create an instance of AddChannelLogBodySchema', function() {
        // TODO: update the code to test AddChannelLogBodySchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AddChannelLogBodySchema);
      });
