...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfServiceSchemaBrand', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfServiceSchemaBrand();
      });

      it('should create an instance of AnyOfServiceSchemaBrand', function() {
        // TODO: update the code to test AnyOfServiceSchemaBrand
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfServiceSchemaBrand);
      });
