...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfPersonSchemaImage', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfPersonSchemaImage();
      });

      it('should create an instance of AnyOfPersonSchemaImage', function() {
        // TODO: update the code to test AnyOfPersonSchemaImage
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfPersonSchemaImage);
      });
