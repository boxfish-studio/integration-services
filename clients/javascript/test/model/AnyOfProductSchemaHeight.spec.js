...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaHeight', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaHeight();
      });

      it('should create an instance of AnyOfProductSchemaHeight', function() {
        // TODO: update the code to test AnyOfProductSchemaHeight
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaHeight);
      });
