...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfServiceSchemaServiceOutput', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfServiceSchemaServiceOutput();
      });

      it('should create an instance of AnyOfServiceSchemaServiceOutput', function() {
        // TODO: update the code to test AnyOfServiceSchemaServiceOutput
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfServiceSchemaServiceOutput);
      });
