...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductSchemaAggregateRatingAuthor', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.ProductSchemaAggregateRatingAuthor();
      });

      it('should create an instance of ProductSchemaAggregateRatingAuthor', function() {
        // TODO: update the code to test ProductSchemaAggregateRatingAuthor
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.ProductSchemaAggregateRatingAuthor);
      });
