...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TopicSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.TopicSchema();
      });

      it('should create an instance of TopicSchema', function() {
        // TODO: update the code to test TopicSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.TopicSchema);
      });
