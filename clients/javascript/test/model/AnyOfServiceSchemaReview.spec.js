...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfServiceSchemaReview', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfServiceSchemaReview();
      });

      it('should create an instance of AnyOfServiceSchemaReview', function() {
        // TODO: update the code to test AnyOfServiceSchemaReview
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfServiceSchemaReview);
      });
