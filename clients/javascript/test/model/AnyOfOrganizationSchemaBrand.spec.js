...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfOrganizationSchemaBrand', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfOrganizationSchemaBrand();
      });

      it('should create an instance of AnyOfOrganizationSchemaBrand', function() {
        // TODO: update the code to test AnyOfOrganizationSchemaBrand
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfOrganizationSchemaBrand);
      });
