...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfClaimSchemaType', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfClaimSchemaType();
      });

      it('should create an instance of AnyOfClaimSchemaType', function() {
        // TODO: update the code to test AnyOfClaimSchemaType
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfClaimSchemaType);
      });
