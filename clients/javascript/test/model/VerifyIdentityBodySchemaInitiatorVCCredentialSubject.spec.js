...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VerifyIdentityBodySchemaInitiatorVCCredentialSubject', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.VerifyIdentityBodySchemaInitiatorVCCredentialSubject();
      });

      it('should create an instance of VerifyIdentityBodySchemaInitiatorVCCredentialSubject', function() {
        // TODO: update the code to test VerifyIdentityBodySchemaInitiatorVCCredentialSubject
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.VerifyIdentityBodySchemaInitiatorVCCredentialSubject);
      });
