...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaAggregateRatingImage', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingImage();
      });

      it('should create an instance of AnyOfProductSchemaAggregateRatingImage', function() {
        // TODO: update the code to test AnyOfProductSchemaAggregateRatingImage
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingImage);
      });
