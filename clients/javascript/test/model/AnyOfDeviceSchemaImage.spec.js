...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfDeviceSchemaImage', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfDeviceSchemaImage();
      });

      it('should create an instance of AnyOfDeviceSchemaImage', function() {
        // TODO: update the code to test AnyOfDeviceSchemaImage
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfDeviceSchemaImage);
      });
