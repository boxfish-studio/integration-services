...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfServiceSchemaProvider', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfServiceSchemaProvider();
      });

      it('should create an instance of AnyOfServiceSchemaProvider', function() {
        // TODO: update the code to test AnyOfServiceSchemaProvider
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfServiceSchemaProvider);
      });
