...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ValidateBodySchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.ValidateBodySchema();
      });

      it('should create an instance of ValidateBodySchema', function() {
        // TODO: update the code to test ValidateBodySchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.ValidateBodySchema);
      });
