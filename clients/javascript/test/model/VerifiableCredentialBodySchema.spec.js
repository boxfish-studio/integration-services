...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VerifiableCredentialBodySchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.VerifiableCredentialBodySchema();
      });

      it('should create an instance of VerifiableCredentialBodySchema', function() {
        // TODO: update the code to test VerifiableCredentialBodySchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.VerifiableCredentialBodySchema);
      });
