...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfDeviceSchemaSameAs', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfDeviceSchemaSameAs();
      });

      it('should create an instance of AnyOfDeviceSchemaSameAs', function() {
        // TODO: update the code to test AnyOfDeviceSchemaSameAs
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfDeviceSchemaSameAs);
      });
