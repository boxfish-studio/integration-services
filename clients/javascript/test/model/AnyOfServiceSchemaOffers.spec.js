...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfServiceSchemaOffers', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfServiceSchemaOffers();
      });

      it('should create an instance of AnyOfServiceSchemaOffers', function() {
        // TODO: update the code to test AnyOfServiceSchemaOffers
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfServiceSchemaOffers);
      });
