...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaManufacturerBrand', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaManufacturerBrand();
      });

      it('should create an instance of AnyOfProductSchemaManufacturerBrand', function() {
        // TODO: update the code to test AnyOfProductSchemaManufacturerBrand
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaManufacturerBrand);
      });
