...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaOffers', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaOffers();
      });

      it('should create an instance of AnyOfProductSchemaOffers', function() {
        // TODO: update the code to test AnyOfProductSchemaOffers
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaOffers);
      });
