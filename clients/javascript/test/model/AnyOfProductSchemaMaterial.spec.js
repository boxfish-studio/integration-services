...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaMaterial', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaMaterial();
      });

      it('should create an instance of AnyOfProductSchemaMaterial', function() {
        // TODO: update the code to test AnyOfProductSchemaMaterial
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaMaterial);
      });
