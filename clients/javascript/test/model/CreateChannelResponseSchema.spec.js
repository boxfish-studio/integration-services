...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateChannelResponseSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.CreateChannelResponseSchema();
      });

      it('should create an instance of CreateChannelResponseSchema', function() {
        // TODO: update the code to test CreateChannelResponseSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.CreateChannelResponseSchema);
      });
