...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaReviewSameAs', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaReviewSameAs();
      });

      it('should create an instance of AnyOfProductSchemaReviewSameAs', function() {
        // TODO: update the code to test AnyOfProductSchemaReviewSameAs
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaReviewSameAs);
      });
