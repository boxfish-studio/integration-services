...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductSchemaReviewReviewRating', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.ProductSchemaReviewReviewRating();
      });

      it('should create an instance of ProductSchemaReviewReviewRating', function() {
        // TODO: update the code to test ProductSchemaReviewReviewRating
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.ProductSchemaReviewReviewRating);
      });
