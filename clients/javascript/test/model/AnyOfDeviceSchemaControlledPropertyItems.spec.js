...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfDeviceSchemaControlledPropertyItems', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfDeviceSchemaControlledPropertyItems();
      });

      it('should create an instance of AnyOfDeviceSchemaControlledPropertyItems', function() {
        // TODO: update the code to test AnyOfDeviceSchemaControlledPropertyItems
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfDeviceSchemaControlledPropertyItems);
      });
