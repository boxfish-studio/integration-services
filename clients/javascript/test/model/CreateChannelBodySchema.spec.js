...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateChannelBodySchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.CreateChannelBodySchema();
      });

      it('should create an instance of CreateChannelBodySchema', function() {
        // TODO: update the code to test CreateChannelBodySchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.CreateChannelBodySchema);
      });

      it('should have the property subscriptionPassword (base name: "subscriptionPassword")', function() {
        // TODO: update the code to test the property subscriptionPassword
        expect(instance).to.have.property('subscriptionPassword');
        // expect(instance.subscriptionPassword).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property hasPresharedKey (base name: "hasPresharedKey")', function() {
        // TODO: update the code to test the property hasPresharedKey
        expect(instance).to.have.property('hasPresharedKey');
        // expect(instance.hasPresharedKey).to.be(expectedValueLiteral);
      });
