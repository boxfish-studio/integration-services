...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2002', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.InlineResponse2002();
      });

      it('should create an instance of InlineResponse2002', function() {
        // TODO: update the code to test InlineResponse2002
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.InlineResponse2002);
      });

      it('should have the property trustedRoots (base name: "trustedRoots")', function() {
        // TODO: update the code to test the property trustedRoots
        expect(instance).to.have.property('trustedRoots');
        // expect(instance.trustedRoots).to.be(expectedValueLiteral);
      });
