...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfServiceSchemaAvailableChannelSameAs', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfServiceSchemaAvailableChannelSameAs();
      });

      it('should create an instance of AnyOfServiceSchemaAvailableChannelSameAs', function() {
        // TODO: update the code to test AnyOfServiceSchemaAvailableChannelSameAs
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfServiceSchemaAvailableChannelSameAs);
      });
