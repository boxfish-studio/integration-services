...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaWeight', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaWeight();
      });

      it('should create an instance of AnyOfProductSchemaWeight', function() {
        // TODO: update the code to test AnyOfProductSchemaWeight
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaWeight);
      });
