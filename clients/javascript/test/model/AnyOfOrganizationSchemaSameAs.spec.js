...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfOrganizationSchemaSameAs', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfOrganizationSchemaSameAs();
      });

      it('should create an instance of AnyOfOrganizationSchemaSameAs', function() {
        // TODO: update the code to test AnyOfOrganizationSchemaSameAs
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfOrganizationSchemaSameAs);
      });
