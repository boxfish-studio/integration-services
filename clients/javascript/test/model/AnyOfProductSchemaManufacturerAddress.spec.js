...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaManufacturerAddress', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaManufacturerAddress();
      });

      it('should create an instance of AnyOfProductSchemaManufacturerAddress', function() {
        // TODO: update the code to test AnyOfProductSchemaManufacturerAddress
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaManufacturerAddress);
      });
