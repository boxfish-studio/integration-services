...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfDeviceSchemaControlledAsset', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfDeviceSchemaControlledAsset();
      });

      it('should create an instance of AnyOfDeviceSchemaControlledAsset', function() {
        // TODO: update the code to test AnyOfDeviceSchemaControlledAsset
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfDeviceSchemaControlledAsset);
      });
