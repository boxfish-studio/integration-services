...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfDeviceSchemaOwner', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfDeviceSchemaOwner();
      });

      it('should create an instance of AnyOfDeviceSchemaOwner', function() {
        // TODO: update the code to test AnyOfDeviceSchemaOwner
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfDeviceSchemaOwner);
      });
