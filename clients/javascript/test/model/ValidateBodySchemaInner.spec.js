...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ValidateBodySchemaInner', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.ValidateBodySchemaInner();
      });

      it('should create an instance of ValidateBodySchemaInner', function() {
        // TODO: update the code to test ValidateBodySchemaInner
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.ValidateBodySchemaInner);
      });
