...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfPersonSchemaHeight', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfPersonSchemaHeight();
      });

      it('should create an instance of AnyOfPersonSchemaHeight', function() {
        // TODO: update the code to test AnyOfPersonSchemaHeight
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfPersonSchemaHeight);
      });
