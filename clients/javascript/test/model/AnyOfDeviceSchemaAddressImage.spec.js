...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfDeviceSchemaAddressImage', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfDeviceSchemaAddressImage();
      });

      it('should create an instance of AnyOfDeviceSchemaAddressImage', function() {
        // TODO: update the code to test AnyOfDeviceSchemaAddressImage
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfDeviceSchemaAddressImage);
      });
