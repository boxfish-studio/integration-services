...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthorizeSubscriptionBodySchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AuthorizeSubscriptionBodySchema();
      });

      it('should create an instance of AuthorizeSubscriptionBodySchema', function() {
        // TODO: update the code to test AuthorizeSubscriptionBodySchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AuthorizeSubscriptionBodySchema);
      });
