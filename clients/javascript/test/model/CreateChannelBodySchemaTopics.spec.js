...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateChannelBodySchemaTopics', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.CreateChannelBodySchemaTopics();
      });

      it('should create an instance of CreateChannelBodySchemaTopics', function() {
        // TODO: update the code to test CreateChannelBodySchemaTopics
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.CreateChannelBodySchemaTopics);
      });
