...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChannelAddressSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.ChannelAddressSchema();
      });

      it('should create an instance of ChannelAddressSchema', function() {
        // TODO: update the code to test ChannelAddressSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.ChannelAddressSchema);
      });
