...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfPersonSchemaSameAs', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfPersonSchemaSameAs();
      });

      it('should create an instance of AnyOfPersonSchemaSameAs', function() {
        // TODO: update the code to test AnyOfPersonSchemaSameAs
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfPersonSchemaSameAs);
      });
