...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VerifyIdentityBodySchemaSubjectClaim', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.VerifyIdentityBodySchemaSubjectClaim();
      });

      it('should create an instance of VerifyIdentityBodySchemaSubjectClaim', function() {
        // TODO: update the code to test VerifyIdentityBodySchemaSubjectClaim
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.VerifyIdentityBodySchemaSubjectClaim);
      });
