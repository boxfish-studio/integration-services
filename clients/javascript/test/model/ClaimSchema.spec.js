...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ClaimSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.ClaimSchema();
      });

      it('should create an instance of ClaimSchema', function() {
        // TODO: update the code to test ClaimSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.ClaimSchema);
      });
