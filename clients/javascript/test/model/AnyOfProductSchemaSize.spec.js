...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaSize', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaSize();
      });

      it('should create an instance of AnyOfProductSchemaSize', function() {
        // TODO: update the code to test AnyOfProductSchemaSize
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaSize);
      });
