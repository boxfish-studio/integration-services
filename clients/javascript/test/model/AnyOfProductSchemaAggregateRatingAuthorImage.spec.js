...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaAggregateRatingAuthorImage', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingAuthorImage();
      });

      it('should create an instance of AnyOfProductSchemaAggregateRatingAuthorImage', function() {
        // TODO: update the code to test AnyOfProductSchemaAggregateRatingAuthorImage
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingAuthorImage);
      });
