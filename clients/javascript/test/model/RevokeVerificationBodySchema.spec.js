...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RevokeVerificationBodySchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.RevokeVerificationBodySchema();
      });

      it('should create an instance of RevokeVerificationBodySchema', function() {
        // TODO: update the code to test RevokeVerificationBodySchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.RevokeVerificationBodySchema);
      });
