...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateIdentityBodySchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.UpdateIdentityBodySchema();
      });

      it('should create an instance of UpdateIdentityBodySchema', function() {
        // TODO: update the code to test UpdateIdentityBodySchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.UpdateIdentityBodySchema);
      });
