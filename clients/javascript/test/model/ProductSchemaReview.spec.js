...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductSchemaReview', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.ProductSchemaReview();
      });

      it('should create an instance of ProductSchemaReview', function() {
        // TODO: update the code to test ProductSchemaReview
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.ProductSchemaReview);
      });
      ...
      it('should have the property reviewAspect (base name: "reviewAspect")', function() {
        // TODO: update the code to test the property reviewAspect
        expect(instance).to.have.property('reviewAspect');
        // expect(instance.reviewAspect).to.be(expectedValueLiteral);
      });

      it('should have the property reviewBody (base name: "reviewBody")', function() {
        // TODO: update the code to test the property reviewBody
        expect(instance).to.have.property('reviewBody');
        // expect(instance.reviewBody).to.be(expectedValueLiteral);
      });

      it('should have the property reviewRating (base name: "reviewRating")', function() {
        // TODO: update the code to test the property reviewRating
        expect(instance).to.have.property('reviewRating');
        // expect(instance.reviewRating).to.be(expectedValueLiteral);
      });
