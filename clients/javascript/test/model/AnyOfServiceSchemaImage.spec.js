...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfServiceSchemaImage', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfServiceSchemaImage();
      });

      it('should create an instance of AnyOfServiceSchemaImage', function() {
        // TODO: update the code to test AnyOfServiceSchemaImage
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfServiceSchemaImage);
      });
