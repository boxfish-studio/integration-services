...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfPersonSchemaWorksFor', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfPersonSchemaWorksFor();
      });

      it('should create an instance of AnyOfPersonSchemaWorksFor', function() {
        // TODO: update the code to test AnyOfPersonSchemaWorksFor
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfPersonSchemaWorksFor);
      });
