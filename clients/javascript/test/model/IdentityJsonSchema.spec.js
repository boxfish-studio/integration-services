...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IdentityJsonSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.IdentityJsonSchema();
      });

      it('should create an instance of IdentityJsonSchema', function() {
        // TODO: update the code to test IdentityJsonSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.IdentityJsonSchema);
      });
