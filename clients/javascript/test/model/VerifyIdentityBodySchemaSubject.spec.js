...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VerifyIdentityBodySchemaSubject', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.VerifyIdentityBodySchemaSubject();
      });

      it('should create an instance of VerifyIdentityBodySchemaSubject', function() {
        // TODO: update the code to test VerifyIdentityBodySchemaSubject
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.VerifyIdentityBodySchemaSubject);
      });
