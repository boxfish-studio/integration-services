...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaAggregateRatingReviewCount', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingReviewCount();
      });

      it('should create an instance of AnyOfProductSchemaAggregateRatingReviewCount', function() {
        // TODO: update the code to test AnyOfProductSchemaAggregateRatingReviewCount
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingReviewCount);
      });
