...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaManufacturerSameAs', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaManufacturerSameAs();
      });

      it('should create an instance of AnyOfProductSchemaManufacturerSameAs', function() {
        // TODO: update the code to test AnyOfProductSchemaManufacturerSameAs
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaManufacturerSameAs);
      });
