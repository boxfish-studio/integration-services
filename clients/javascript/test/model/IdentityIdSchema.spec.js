...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IdentityIdSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.IdentityIdSchema();
      });

      it('should create an instance of IdentityIdSchema', function() {
        // TODO: update the code to test IdentityIdSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.IdentityIdSchema);
      });
