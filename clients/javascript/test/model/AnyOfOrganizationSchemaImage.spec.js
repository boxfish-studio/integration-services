...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfOrganizationSchemaImage', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfOrganizationSchemaImage();
      });

      it('should create an instance of AnyOfOrganizationSchemaImage', function() {
        // TODO: update the code to test AnyOfOrganizationSchemaImage
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfOrganizationSchemaImage);
      });
