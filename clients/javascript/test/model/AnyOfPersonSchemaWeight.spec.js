...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfPersonSchemaWeight', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfPersonSchemaWeight();
      });

      it('should create an instance of AnyOfPersonSchemaWeight', function() {
        // TODO: update the code to test AnyOfPersonSchemaWeight
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfPersonSchemaWeight);
      });
