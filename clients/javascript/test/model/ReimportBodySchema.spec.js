...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReimportBodySchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.ReimportBodySchema();
      });

      it('should create an instance of ReimportBodySchema', function() {
        // TODO: update the code to test ReimportBodySchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.ReimportBodySchema);
      });
