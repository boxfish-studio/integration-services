...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfDeviceSchemaSource', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfDeviceSchemaSource();
      });

      it('should create an instance of AnyOfDeviceSchemaSource', function() {
        // TODO: update the code to test AnyOfDeviceSchemaSource
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfDeviceSchemaSource);
      });
