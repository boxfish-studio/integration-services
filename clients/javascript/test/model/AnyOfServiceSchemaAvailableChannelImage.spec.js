...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfServiceSchemaAvailableChannelImage', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfServiceSchemaAvailableChannelImage();
      });

      it('should create an instance of AnyOfServiceSchemaAvailableChannelImage', function() {
        // TODO: update the code to test AnyOfServiceSchemaAvailableChannelImage
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfServiceSchemaAvailableChannelImage);
      });
