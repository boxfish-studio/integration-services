...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceSchemaAvailableChannel', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.ServiceSchemaAvailableChannel();
      });

      it('should create an instance of ServiceSchemaAvailableChannel', function() {
        // TODO: update the code to test ServiceSchemaAvailableChannel
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.ServiceSchemaAvailableChannel);
      });
      ...
      it('should have the property availableLanguage (base name: "availableLanguage")', function() {
        // TODO: update the code to test the property availableLanguage
        expect(instance).to.have.property('availableLanguage');
        // expect(instance.availableLanguage).to.be(expectedValueLiteral);
      });
