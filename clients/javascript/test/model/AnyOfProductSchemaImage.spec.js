...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaImage', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaImage();
      });

      it('should create an instance of AnyOfProductSchemaImage', function() {
        // TODO: update the code to test AnyOfProductSchemaImage
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaImage);
      });
