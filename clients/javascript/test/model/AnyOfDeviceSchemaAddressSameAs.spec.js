...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfDeviceSchemaAddressSameAs', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfDeviceSchemaAddressSameAs();
      });

      it('should create an instance of AnyOfDeviceSchemaAddressSameAs', function() {
        // TODO: update the code to test AnyOfDeviceSchemaAddressSameAs
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfDeviceSchemaAddressSameAs);
      });
