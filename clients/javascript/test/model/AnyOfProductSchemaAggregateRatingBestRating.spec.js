...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaAggregateRatingBestRating', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingBestRating();
      });

      it('should create an instance of AnyOfProductSchemaAggregateRatingBestRating', function() {
        // TODO: update the code to test AnyOfProductSchemaAggregateRatingBestRating
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingBestRating);
      });
