...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaWidth', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaWidth();
      });

      it('should create an instance of AnyOfProductSchemaWidth', function() {
        // TODO: update the code to test AnyOfProductSchemaWidth
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaWidth);
      });
