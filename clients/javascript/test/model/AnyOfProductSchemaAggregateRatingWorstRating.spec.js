...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaAggregateRatingWorstRating', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingWorstRating();
      });

      it('should create an instance of AnyOfProductSchemaAggregateRatingWorstRating', function() {
        // TODO: update the code to test AnyOfProductSchemaAggregateRatingWorstRating
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingWorstRating);
      });
