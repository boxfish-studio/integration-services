...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaReviewReviewRatingImage', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaReviewReviewRatingImage();
      });

      it('should create an instance of AnyOfProductSchemaReviewReviewRatingImage', function() {
        // TODO: update the code to test AnyOfProductSchemaReviewReviewRatingImage
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaReviewReviewRatingImage);
      });
