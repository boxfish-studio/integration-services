...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaReviewReviewRatingBestRating', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaReviewReviewRatingBestRating();
      });

      it('should create an instance of AnyOfProductSchemaReviewReviewRatingBestRating', function() {
        // TODO: update the code to test AnyOfProductSchemaReviewReviewRatingBestRating
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaReviewReviewRatingBestRating);
      });
