...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ValidateResponseSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.ValidateResponseSchema();
      });

      it('should create an instance of ValidateResponseSchema', function() {
        // TODO: update the code to test ValidateResponseSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.ValidateResponseSchema);
      });
