...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfDeviceSchemaRssi', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfDeviceSchemaRssi();
      });

      it('should create an instance of AnyOfDeviceSchemaRssi', function() {
        // TODO: update the code to test AnyOfDeviceSchemaRssi
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfDeviceSchemaRssi);
      });
