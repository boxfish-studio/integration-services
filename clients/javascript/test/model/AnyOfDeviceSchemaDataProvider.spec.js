...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfDeviceSchemaDataProvider', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfDeviceSchemaDataProvider();
      });

      it('should create an instance of AnyOfDeviceSchemaDataProvider', function() {
        // TODO: update the code to test AnyOfDeviceSchemaDataProvider
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfDeviceSchemaDataProvider);
      });
