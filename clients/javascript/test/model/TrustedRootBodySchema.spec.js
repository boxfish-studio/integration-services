...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TrustedRootBodySchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.TrustedRootBodySchema();
      });

      it('should create an instance of TrustedRootBodySchema', function() {
        // TODO: update the code to test TrustedRootBodySchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.TrustedRootBodySchema);
      });

      it('should have the property trustedRootId (base name: "trustedRootId")', function() {
        // TODO: update the code to test the property trustedRootId
        expect(instance).to.have.property('trustedRootId');
        // expect(instance.trustedRootId).to.be(expectedValueLiteral);
      });
