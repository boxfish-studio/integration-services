...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrganizationSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.OrganizationSchema();
      });

      it('should create an instance of OrganizationSchema', function() {
        // TODO: update the code to test OrganizationSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.OrganizationSchema);
      });
