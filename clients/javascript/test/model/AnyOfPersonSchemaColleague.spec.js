...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfPersonSchemaColleague', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfPersonSchemaColleague();
      });

      it('should create an instance of AnyOfPersonSchemaColleague', function() {
        // TODO: update the code to test AnyOfPersonSchemaColleague
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfPersonSchemaColleague);
      });
