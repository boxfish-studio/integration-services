...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IdentityJsonSchemaDocProof', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.IdentityJsonSchemaDocProof();
      });

      it('should create an instance of IdentityJsonSchemaDocProof', function() {
        // TODO: update the code to test IdentityJsonSchemaDocProof
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.IdentityJsonSchemaDocProof);
      });
