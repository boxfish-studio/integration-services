...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfOrganizationSchemaAddress', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfOrganizationSchemaAddress();
      });

      it('should create an instance of AnyOfOrganizationSchemaAddress', function() {
        // TODO: update the code to test AnyOfOrganizationSchemaAddress
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfOrganizationSchemaAddress);
      });
