...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IdentityJsonSchemaKey', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.IdentityJsonSchemaKey();
      });

      it('should create an instance of IdentityJsonSchemaKey', function() {
        // TODO: update the code to test IdentityJsonSchemaKey
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.IdentityJsonSchemaKey);
      });
