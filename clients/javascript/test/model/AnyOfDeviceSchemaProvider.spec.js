...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfDeviceSchemaProvider', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfDeviceSchemaProvider();
      });

      it('should create an instance of AnyOfDeviceSchemaProvider', function() {
        // TODO: update the code to test AnyOfDeviceSchemaProvider
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfDeviceSchemaProvider);
      });
