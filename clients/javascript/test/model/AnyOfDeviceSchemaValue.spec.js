...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfDeviceSchemaValue', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfDeviceSchemaValue();
      });

      it('should create an instance of AnyOfDeviceSchemaValue', function() {
        // TODO: update the code to test AnyOfDeviceSchemaValue
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfDeviceSchemaValue);
      });
