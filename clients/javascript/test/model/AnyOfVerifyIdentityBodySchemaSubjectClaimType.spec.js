...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfVerifyIdentityBodySchemaSubjectClaimType', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfVerifyIdentityBodySchemaSubjectClaimType();
      });

      it('should create an instance of AnyOfVerifyIdentityBodySchemaSubjectClaimType', function() {
        // TODO: update the code to test AnyOfVerifyIdentityBodySchemaSubjectClaimType
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfVerifyIdentityBodySchemaSubjectClaimType);
      });
