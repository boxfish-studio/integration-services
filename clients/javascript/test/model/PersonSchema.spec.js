...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PersonSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.PersonSchema();
      });

      it('should create an instance of PersonSchema', function() {
        // TODO: update the code to test PersonSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.PersonSchema);
      });
      ...
      it('should have the property worksFor (base name: "worksFor")', function() {
        // TODO: update the code to test the property worksFor
        expect(instance).to.have.property('worksFor');
        // expect(instance.worksFor).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property colleague (base name: "colleague")', function() {
        // TODO: update the code to test the property colleague
        expect(instance).to.have.property('colleague');
        // expect(instance.colleague).to.be(expectedValueLiteral);
      });
