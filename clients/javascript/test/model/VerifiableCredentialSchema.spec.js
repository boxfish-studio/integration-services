...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VerifiableCredentialSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.VerifiableCredentialSchema();
      });

      it('should create an instance of VerifiableCredentialSchema', function() {
        // TODO: update the code to test VerifiableCredentialSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.VerifiableCredentialSchema);
      });
