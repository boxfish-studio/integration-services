...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthorizeSubscriptionResponseSchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AuthorizeSubscriptionResponseSchema();
      });

      it('should create an instance of AuthorizeSubscriptionResponseSchema', function() {
        // TODO: update the code to test AuthorizeSubscriptionResponseSchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AuthorizeSubscriptionResponseSchema);
      });
