...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RevokeSubscriptionBodySchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.RevokeSubscriptionBodySchema();
      });

      it('should create an instance of RevokeSubscriptionBodySchema', function() {
        // TODO: update the code to test RevokeSubscriptionBodySchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.RevokeSubscriptionBodySchema);
      });
