...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaReviewReviewRatingWorstRating', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaReviewReviewRatingWorstRating();
      });

      it('should create an instance of AnyOfProductSchemaReviewReviewRatingWorstRating', function() {
        // TODO: update the code to test AnyOfProductSchemaReviewReviewRatingWorstRating
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaReviewReviewRatingWorstRating);
      });
