...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaAggregateRatingSameAs', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingSameAs();
      });

      it('should create an instance of AnyOfProductSchemaAggregateRatingSameAs', function() {
        // TODO: update the code to test AnyOfProductSchemaAggregateRatingSameAs
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingSameAs);
      });
