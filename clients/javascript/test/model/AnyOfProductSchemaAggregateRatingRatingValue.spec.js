...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaAggregateRatingRatingValue', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingRatingValue();
      });

      it('should create an instance of AnyOfProductSchemaAggregateRatingRatingValue', function() {
        // TODO: update the code to test AnyOfProductSchemaAggregateRatingRatingValue
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaAggregateRatingRatingValue);
      });
