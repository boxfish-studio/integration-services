...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfProductSchemaManufacturerImage', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfProductSchemaManufacturerImage();
      });

      it('should create an instance of AnyOfProductSchemaManufacturerImage', function() {
        // TODO: update the code to test AnyOfProductSchemaManufacturerImage
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfProductSchemaManufacturerImage);
      });
