...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnyOfPersonSchemaAddress', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.AnyOfPersonSchemaAddress();
      });

      it('should create an instance of AnyOfPersonSchemaAddress', function() {
        // TODO: update the code to test AnyOfPersonSchemaAddress
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.AnyOfPersonSchemaAddress);
      });
