...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VerifyIdentityBodySchema', function() {
      beforeEach(function() {
        instance = new IntegrationServicesApiDocumentation.VerifyIdentityBodySchema();
      });

      it('should create an instance of VerifyIdentityBodySchema', function() {
        // TODO: update the code to test VerifyIdentityBodySchema
        expect(instance).to.be.a(IntegrationServicesApiDocumentation.VerifyIdentityBodySchema);
      });
      ...
      it('should have the property initiatorVC (base name: "initiatorVC")', function() {
        // TODO: update the code to test the property initiatorVC
        expect(instance).to.have.property('initiatorVC');
        // expect(instance.initiatorVC).to.be(expectedValueLiteral);
      });
